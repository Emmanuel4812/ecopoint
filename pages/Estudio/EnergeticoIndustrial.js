...
const EnergeticoIndustrial = () => {
    return (
        <>
            <NavbarInner/>
            <div className='b py-16 bg-green-500 px-4 sm:px-6 h-screen w-screen flex justify-center items-center background-index pt-36'>                
...
export default EnergeticoIndustrial