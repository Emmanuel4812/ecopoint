        ...
        <div>
            ...
            <div className="absolute z-10 flex justify-center w-full grid grid-rows-3 mt-80">
                ...
                <div className="flex space-x-8 justify-center h-10 mt-10 ">
                   <pre className="text-3xl font-regular text-white font-sans text-center">{`Lleva tus procesos industriales aun nivel más
ecológicos con calentadores solares`}</pre>                  
                </div>
            ...
            <img className="relative z-0 bg-auto " src='calentadorIndustriaImage.jpg'></img>
            <Footer/>      
        </div>
    );
}
